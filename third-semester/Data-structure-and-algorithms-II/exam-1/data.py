...
illnesses = ["Covid-19", "Cancer", "Diabetes", "Hipertension", "Enfermedad pulmonar obstructiva crónica", "Enfermedad renal crónica", 
                "Enfermedad cardiovascular", "Enfermedad cerebrovascular", "Enfermedad hepática crónica", "Enfermedad neurológica crónica",
                 "Enfermedad autoinmune", "Enfermedad metabólica", "Enfermedad respiratoria crónica", "Enfermedad gastrointestinal crónica",
                  "Enfermedad neurológica crónica", "Enfermedad autoinmune", "Enfermedad metabólica", "Enfermedad respiratoria crónica",
                   "Enfermedad gastrointestinal crónica", "Enfermedad neurológica crónica", "Enfermedad autoinmune", 
                   "Enfermedad metabólica", "Enfermedad respiratoria crónica", "Enfermedad gastrointestinal crónica", 
                   "Enfermedad neurológica crónica", "Enfermedad autoinmune", "Enfermedad metabólica", "Enfermedad respiratoria crónica", 
                   "Enfermedad gastrointestinal crónica", "Enfermedad neurológica crónica", "Enfermedad autoinmune", "Enfermedad metabólica",
                    "Enfermedad respiratoria crónica", "Enfermedad gastrointestinal crónica", "Enfermedad neurológica crónica", 
                    "Enfermedad autoinmune", "Enfermedad metabólica", "Enfermedad respiratoria crónica", "Enfermedad gastrointestinal crónica", 
                    "Enfermedad neurológica crónica", "Enfermedad autoinmune", "Enfermedad metabólica", "Enfermedad respiratoria crónica", 
                    "Enfermedad gastrointestinal crónica", "Enfermedad neurológica crónica", "Enfermedad autoinmune", "Enfermedad metabólica", 
                    "Enfermedad respiratoria crónica", "Enfermedad gastrointestinal crónica", "Enfermedad neurológica crónica", "Enfermedad autoinmune",
                     "Enfermedad metabólica"]

statuses = ["Prediagnóstico", "Exámenes de Laboratorio", "Tratamiento", "Salida"]